...
sleep(5)    
username = driver.find_element(By.CSS_SELECTOR, "#_R_1h6kqsqppb6amH1_").send_keys("abc@gmail.com")
password = driver.find_element(By.CSS_SELECTOR, "#_R_1hmkqsqppb6amH1_").send_keys("1234567")
sleep(2)
login_button = driver.find_element(By.CSS_SELECTOR, "div[aria-label='Log in']").click()
sleep(5)
driver.close()
